...
(function ($) {
  ...
  var $dark_mode_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('body').hasClass('dark-mode') || localStorage.getItem("dark-mode") == "true",
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
  ...
  const nav_bar_header = document.getElementById('user-main-header')
const body = document.getElementsByTagName('body')[0]

// USER PREFERENCES
const darkMode = localStorage.getItem('dark-mode')
const navBarColor = localStorage.getItem('navbar-color')
